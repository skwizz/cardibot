...
_isMentioningJdh(message) = function() {
  ...
  } else if (_isMentioningJdhBasic(message)) {
    _replyJdhBasic(message);
  } else if (_isMentioningJdhChuck(message)) {
  _replyJdhChuck(message);
  } else if (_isMentioningScores(message)) {
  _replyScores(message);
  } else if (_isMentioningTaux(message)) {
  _replyTaux(message);
  } else if (_isMentioningDuel(message)) {
  _replyDuel(message);
  } else if (_isMentioningJaccepte(message)) {
  _replyJaccepte(message);
  }
}
