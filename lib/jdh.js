var Jdh = function() {
  ...
  this._isMentioningJdh = function(message) {
    if (_isMentioningSommaire(message)) {
    _replySommaire(message);
  ...
  this._replySommaire = function (message) {
    var self = this;
  ...
  this._replyJdhBasic = function (message) {
    // Espérance : 45
  ...
  this._replyJdhChuck = function (message) {
    // Espérance : 0
  ...
  this._replyScores = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
  ...
  this._replyTaux = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
  ...
  this._isMentioningDuel = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
  ...
  this._replyDuel = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
  ...
  this._replyJaccepte = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
  ...
  this._isJdhPlayer = function (id, callback) {
  ...
  this._playJdh = function(message, points) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
  ...
  this._sanctionAleatoire = function () {
    var self = this;
    var sanction = 200;
    var recompense = 100;
  ...
  this._deciderRecompense = function () {
    var self = this;
