...
var restau = ["Corse", "Sub", "Mongoo", "Jap jusqu'à 15 heures", "Domac", "Pegast", "les burgers Hipster bio",
    "Bagel", "Toto pizza", "BK ma gueule", "Toto pates", "Goutu", "un nouveau resto tu testeras", "Korean"];
...
var Manger = function () {
    ...
    this._replyMangerListe = function (message, cardibot) {
        ...
        cardibot.postTo(channel, res, {as_user: true});
    }
};
