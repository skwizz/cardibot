var Cardicraft = function() {
  ...
  this._replyCardicraft = function (message) {
  ...
  this._replySommaireCardicraft = function (message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var resString = "";
  ...
  this._replyStartCardicraft=function(message){
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyInfosCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyCoutsCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyAchatmineCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyAchatcaserneCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  //demande d'info sur la session de cardicraft
  this._replyTrainCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyCibleCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._replyAttackCardicraft=function(message) {
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString_att = "";
  ...
  this._replyNotImplementedYet = function (message){
    var self = this;
    var channel = self._getChannelOrUser(message);
    var ID = message.user;
    var resString = "";
  ...
  this._MajCardior = function(timestamp2){
    var self = this;
