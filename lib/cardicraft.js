...
var Cardicraft = function () {
    ...
    this._replyResetCardicraft = function (message, cardibot) {
        ...
        if (ID == 'U0M2ZCL6T'){
            ...
            resString += ":rotating_light: ALERTE ! CARDICRAFT A ETE REINITIALISE ! ALERTE ! :rotating_light:  \n Bonne chance les Kim-Jung-Un Junior :rocket:"
        } else {
           resString += "L'individu <@" + ID + "> a essayé de réinitialiser CARDICRAFT, merci de le lyncher sur la place publique !";
        }
        cardibot.postTo("random", resString, {as_user: true});
    };
