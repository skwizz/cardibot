...
Cardibot.prototype._cronJobs = function () {
  ...
  // Decider de la recompense que doit le perdant au gagnant a la fin de la semaine
  new CronJob("00 00 18 * * 5", function() {
    var recompenses = ["une bière au prochain afterwork", "un pain au chocolat lundi matin", "3 cookies au prochain Sub", "un café flemme"];
    var indice = Math.trunc(Math.random() * recompenses.length);
    console.log("Récompense fixée");
    // TODO: Mettre le nom du perdant et du gagnant
    this.postTo("random", "Le perdant doit " + recompenses[indice] + "au gagnant !", {as_user: true});
  }, null, true, "Europe/Paris");
}
...
Cardibot.prototype._deciderRecompense = function (message) {
  var self = this;
}
...
// TODO: Jackpot +1000 ou -1000 de temps en temps (1/500)
// TODO: Stats de la journée et de la semaine (moyenne, max et min)
// TODO: Sanction et récompense aléatoire a la fin de la journée
