...
Cardibot.prototype._cronJobs = function () {
  ...
  // Pause de midi
  new CronJob("00 37 17 * * 1-5", function() {
...
Cardibot.prototype._onMessage = function (message) {
  if ((this._isMessageOk(message)) && (this._getChannelOrUser(message).name === "random")) {
...
// TODO: Stocker et utiliser les noms au lieu des ids des users ?
