...
Cardibot.prototype._replySacha = function (message) {
  var self = this;
  var channel = self._getChannelOrUser(message);
  self.db.query("CREATE TABLE cardicraft (id varchar(20) NOT NULL, nom varchar(40) NOT NULL, ressource bigint, niveauBat smallint, niveauUnit smallint, timestamp bigint);", function(err, result) {
