...
Cardibot.prototype._firstRunCheck = function () {
  console.log("LOG1");
  var self = this;
  self.db.get('SELECT val FROM info WHERE name = "lastrun" LIMIT 1', function (err, record) {
    ...
    console.log("JE VAIS BIEN ICI");
  });
};

Cardibot.prototype._welcomeMessage = function () {
  console.log("LOG3");
  this.postMessageToChannel(this.channels[0].name, "Salut mes petits stagiaires ! Alors la pause est enfin finie ?",
  {as_user: true});
};
