...
Cardibot.prototype._isMentioningSacha = function (message) {
  return message.text.toLowerCase().indexOf("!sachasecretcommand") > -1;
};
...
Cardibot.prototype._playJdh = function(message, points) {
  ...
  if (mecQuiAccepte=="U0M2ZCL6T"){
    self.postTo(channel.name, "PUTAIN VICKY T'AS TOUJOURS PAS COMPRIS QUE T'ES NULL ?", {as_user: true});
  }
